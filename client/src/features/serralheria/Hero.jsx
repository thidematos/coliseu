...
function Hero() {
  ...
  return (
    <section
      className={`flex h-dvh flex-col items-center justify-start gap-10 md:h-auto lg:h-dvh lg:gap-0`}
    >
      <NavDummy />
      {isBiggerThanMobile ? (
        <div className="md:mx-[8%] md:grid md:grid-cols-7 md:gap-10 md:pb-20 md:pt-10 lg:grid-cols-2 lg:py-10">
          ...
          <img src="/hero.jpg" className="md:col-span-4 lg:col-span-1" />
        </div>
      ) : (
        <>
          <Impact />
